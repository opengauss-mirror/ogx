...
use ogx::array::RawArray;
use ogx::prelude::*;
use ogx::{Array, Json};
use serde_json::*;

#[og_extern(name = "sum_array")]
...
#[og_extern(name = "sum_array_sliced")]
#[allow(deprecated)]
...
mod tests {
    ...
    #[og_test(error = "attempt to add with overflow")]
    ...
    #[og_test(error = "array contains NULL")]
