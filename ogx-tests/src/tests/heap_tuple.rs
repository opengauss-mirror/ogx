...
use ogx::prelude::*;
use ogx::{Aggregate, VariadicArray};
...
mod arguments {
    ...
    mod singleton {
        ...
        #[og_extern]
        fn gets_name_field(dog: Option<ogx::composite_type!("Dog")>) -> Option<&str> {
            // Gets resolved to:
        ...
        fn gets_name_field_default(
            dog: default!(ogx::composite_type!("Dog"), "ROW('Nami', 0)::Dog"),
        ) -> &str {
            // Gets resolved to:
        ...
        #[og_extern]
        fn gets_name_field_strict(dog: ogx::composite_type!("Dog")) -> &str {
            // Gets resolved to:
            let dog: PgHeapTuple<AllocatedByRust> = dog;
    ...
    mod variadic_array {
        ...
        fn gets_name_field_variadic(
            dogs: VariadicArray<ogx::composite_type!(DOG_COMPOSITE_TYPE)>,
        ) -> Vec<String> {
            // Gets resolved to:
            let dogs: ogx::VariadicArray<PgHeapTuple<AllocatedByRust>> = dogs;
        ...
        fn gets_name_field_default_variadic(
            dogs: default!(
                VariadicArray<ogx::composite_type!("Dog")>,
        ...
        fn gets_name_field_strict_variadic(
            dogs: ogx::VariadicArray<ogx::composite_type!("Dog")>,
        ) -> Vec<String> {
            // Gets resolved to:
            let dogs: ogx::VariadicArray<PgHeapTuple<AllocatedByRust>> = dogs;
    ...
    mod vec {
        ...
        fn sum_scritches_for_names(
            dogs: Option<Vec<ogx::composite_type!(DOG_COMPOSITE_TYPE)>>,
        ) -> i32 {
            // Gets resolved to:
        ...
        fn sum_scritches_for_names_default(
            dogs: ogx::default!(Vec<ogx::composite_type!("Dog")>, "ARRAY[ROW('Nami', 0)]::Dog[]"),
        ) -> i32 {
            // Gets resolved to:
        ...
        #[og_extern]
        fn sum_scritches_for_names_strict(dogs: Vec<ogx::composite_type!("Dog")>) -> i32 {
            // Gets resolved to:
            let dogs: Vec<PgHeapTuple<AllocatedByRust>> = dogs;
        ...
        fn sum_scritches_for_names_strict_optional_items(
            dogs: Vec<Option<ogx::composite_type!("Dog")>>,
        ) -> i32 {
            // Gets resolved to:
        ...
        fn sum_scritches_for_names_default_optional_items(
            dogs: ogx::default!(
                Vec<Option<ogx::composite_type!("Dog")>>,
                "ARRAY[ROW('Nami', 0)]::Dog[]"
            ),
        ) -> i32 {
            // Gets resolved to:
        ...
        fn sum_scritches_for_names_optional_items(
            dogs: Option<Vec<Option<ogx::composite_type!("Dog")>>>,
        ) -> i32 {
            // Gets resolved to:
    ...
    mod array {
        ...
        fn sum_scritches_for_names_array(
            dogs: Option<ogx::Array<ogx::composite_type!("Dog")>>,
        ) -> i32 {
            // Gets resolved to:
            let dogs: Option<ogx::Array<PgHeapTuple<AllocatedByRust>>> = dogs;
        ...
        fn sum_scritches_for_names_array_default(
            dogs: ogx::default!(
                ogx::Array<ogx::composite_type!("Dog")>,
                "ARRAY[ROW('Nami', 0)]::Dog[]"
            ),
        ) -> i32 {
            // Gets resolved to:
            let dogs: ogx::Array<PgHeapTuple<AllocatedByRust>> = dogs;
        ...
        fn sum_scritches_for_names_array_strict(
            dogs: ogx::Array<ogx::composite_type!("Dog")>,
        ) -> i32 {
            // Gets resolved to:
            let dogs: ogx::Array<PgHeapTuple<AllocatedByRust>> = dogs;
...
mod returning {
    ...
    mod singleton {
        ...
        #[og_extern]
        fn create_dog(name: String, scritches: i32) -> ogx::composite_type!("Dog") {
        ...
        #[og_extern]
        fn scritch(
            maybe_dog: Option<::ogx::composite_type!("Dog")>,
        ) -> Option<ogx::composite_type!("Dog")> {
            // Gets resolved to:
        ...
        #[og_extern]
        fn scritch_strict(dog: ::ogx::composite_type!("Dog")) -> ogx::composite_type!("Dog") {
            // Gets resolved to:
    ...
    mod vec {
        ...
        #[og_extern]
        fn scritch_all_vec(
            maybe_dogs: Option<Vec<::ogx::composite_type!("Dog")>>,
        ) -> Option<Vec<::ogx::composite_type!("Dog")>> {
            // Gets resolved to:
        ...
        fn scritch_all_vec_strict(
            dogs: Vec<::ogx::composite_type!("Dog")>,
        ) -> Vec<::ogx::composite_type!("Dog")> {
            // Gets resolved to:
        ...
        fn scritch_all_vec_optional_items(
            maybe_dogs: Option<Vec<Option<::ogx::composite_type!("Dog")>>>,
        ) -> Option<Vec<Option<::ogx::composite_type!("Dog")>>> {
            // Gets resolved to:
...
mod sql_generator_tests {
    ...
    fn exotic_signature(
        _cats: ogx::default!(
            Option<Vec<Option<::ogx::composite_type!("Cat")>>>,
            "ARRAY[ROW('Sally', 0)]::Cat[]"
        ),
        _a_single_fish: ogx::default!(
            Option<::ogx::composite_type!("Fish")>,
            "ROW('Bob', 0)::Fish"
        ),
        _dogs: ogx::default!(
            Option<::ogx::VariadicArray<::ogx::composite_type!("Dog")>>,
            "ARRAY[ROW('Nami', 0), ROW('Brandy', 0)]::Dog[]"
        ),
    ) -> TableIterator<
        'static,
        (
            name!(dog, Option<::ogx::composite_type!("Dog")>),
            name!(cat, Option<::ogx::composite_type!("Cat")>),
            name!(fish, Option<::ogx::composite_type!("Fish")>),
            name!(related_edges, Option<Vec<::ogx::composite_type!("AnimalFriendshipEdge")>>),
        ),
    > {
    ...
    fn iterable_named_table() -> TableIterator<
        'static,
        (name!(dog, ::ogx::composite_type!("Dog")), name!(cat, ::ogx::composite_type!("Cat"))),
    > {
        TableIterator::new(Vec::new().into_iter())
    }
    ...
    fn iterable_named_table_array_elems() -> TableIterator<
        'static,
        (
            name!(dog, Vec<::ogx::composite_type!("Dog")>),
            name!(cat, Vec<::ogx::composite_type!("Cat")>),
        ),
    > {
        TableIterator::once(Default::default())
    }
    ...
    fn iterable_named_table_optional_array_elems() -> TableIterator<
        'static,
        (
            name!(dog, Option<Vec<::ogx::composite_type!("Dog")>>),
            name!(cat, Option<Vec<::ogx::composite_type!("Cat")>>),
        ),
    > {
        TableIterator::once(Default::default())
    }
    ...
    fn iterable_named_table_optional_array_optional_elems() -> TableIterator<
        'static,
        (
            name!(dog, Option<Vec<Option<::ogx::composite_type!("Dog")>>>),
            name!(cat, Option<Vec<Option<::ogx::composite_type!("Cat")>>>),
        ),
    > {
        TableIterator::once(Default::default())
    }
    ...
    #[allow(unused_parens)]
    #[og_extern]
    fn return_table_single() -> TableIterator<'static, (name!(dog, ogx::composite_type!("Dog")),)> {
        let mut tuple = PgHeapTuple::new_composite_type("Dog").unwrap();
    ...
    ) -> TableIterator<'static, (name!(dog, ogx::composite_type!("Dog")),)> {
        let mut tuple = PgHeapTuple::new_composite_type("Dog").unwrap();
    ...
    impl Aggregate for AggregateWithOrderedSetArgs {
        type Args = name!(input, ogx::composite_type!("Dog"));
        type State = ogx::composite_type!("Dog");
        type Finalize = ogx::composite_type!("Dog");
        const ORDERED_SET: bool = true;
        type OrderedSetArgs = name!(percentile, ogx::composite_type!("Dog"));
    ...
    impl Aggregate for AggregateWithMovingState {
        type Args = ogx::composite_type!("Dog");
        type State = ogx::composite_type!("Dog");
        type MovingState = ogx::composite_type!("Dog");
...
mod tests {
    ...
    use ogx::datum::TryFromDatumError;
