...
// if our openGauss ERROR and Rust panic!() handling is incorrect, this little bit of useless code
// will crash openGauss.  If things are correct it'll simply raise an ERROR saying "panic in walker".
#[og_extern]
fn crash() {
    unsafe {
...
mod tests {
    ...
    #[og_test(error = "unwrapped a panic")]
