...
*/
use super::get_ogx_attr_macro;
use crate::sql_entity_graph::og_extern::NameMacro;
...
impl AggregateType {
    pub fn new(ty: syn::Type) -> Result<Self, syn::Error> {
        let (name_macro, name) = if let Some(name_macro) = get_ogx_attr_macro("name", &ty) {
    ...
    pub fn entity_tokens(&self) -> Expr {
        ...
        parse_quote! {
            ::ogx::utils::sql_entity_graph::AggregateTypeEntity {
