...
pub struct OgAggregateEntity {
    ...
    ///
    /// The implementor of an [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `state` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `finalize` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `FINALIZE_MODIFY` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `combine` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `serial` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `deserial` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `INITIAL_CONDITION` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `moving_state` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `moving_state_inverse` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `MovingState` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `moving_state_finalize` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `MOVING_FINALIZE_MODIFY` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `MOVING_INITIAL_CONDITION` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `SORT_OPERATOR` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `PARALLEL` in [`ogx::aggregate::Aggregate`].
    ...
    ///
    /// Corresponds to `hypothetical` in [`ogx::aggregate::Aggregate`].
    pub hypothetical: bool,
    pub to_sql_config: ToSqlConfigEntity,
}

impl Ord for OgAggregateEntity {
    fn cmp(&self, other: &Self) -> Ordering {
        self.file.cmp(other.full_path).then_with(|| self.file.cmp(other.full_path))
    }
}

impl PartialOrd for OgAggregateEntity {
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        Some(self.cmp(other))
    }
}

impl From<OgAggregateEntity> for SqlGraphEntity {
    fn from(val: OgAggregateEntity) -> Self {
        SqlGraphEntity::Aggregate(val)
    }
}

impl SqlGraphIdentifier for OgAggregateEntity {
...
impl ToSql for OgAggregateEntity {
