...
`ogx::extension_sql!()` related entities for Rust to SQL translation
...
impl SqlDeclaredEntity {
    pub fn build(variant: impl AsRef<str>, name: impl AsRef<str>) -> eyre::Result<Self> {
        ...
        let data = SqlDeclaredEntityData {
            ...
            pg_box: vec![
                format!("ogx::ogbox::OgBox<{}>", name),
                format!("ogx::ogbox::OgBox<{}, ogx::ogbox::AllocatedByRust>", name),
                format!("ogx::ogbox::OgBox<{}, ogx::ogbox::AllocatedByOpenGauss>", name),
            ],
        };
