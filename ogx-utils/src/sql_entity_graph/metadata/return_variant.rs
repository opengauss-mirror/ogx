...
/// See the openGauss documentation for [CREATE FUNCTION]
/// [CREATE FUNCTION]: https://docs.opengauss.org/zh/docs/3.1.0/docs/Developerguide/dolphin-CREATE-FUNCTION.html
