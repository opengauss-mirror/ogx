...
`#[og_extern]` related operator entities for Rust to SQL translation
...
/// The output of a [`OgOperator`](crate::sql_entity_graph::OgOperator) from `quote::ToTokens::to_tokens`.
#[derive(Debug, Clone, Hash, PartialEq, Eq, PartialOrd, Ord, Serialize, Deserialize)]
pub struct OgOperatorEntity {
