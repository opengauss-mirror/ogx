...
`#[og_extern]` return value related macro expansion for Rust to SQL translation
    ...
    fn to_tokens(&self, tokens: &mut TokenStream2) {
        let quoted = match self {
            Returning::None => quote! {
                ::ogx::utils::sql_entity_graph::OgExternReturnEntity::None
            },
            Returning::Type(used_ty) => {
                let used_ty_entity_tokens = used_ty.entity_tokens();
                quote! {
                    ::ogx::utils::sql_entity_graph::OgExternReturnEntity::Type {
            ...
            Returning::SetOf {
                ...
                let used_ty_entity_tokens = used_ty.entity_tokens();
                quote! {
                    ::ogx::utils::sql_entity_graph::OgExternReturnEntity::SetOf {
                        ty: #used_ty_entity_tokens,
                        optional: #optional,
                    }
                }
            ...
            Returning::Iterated {
                ...
                let quoted_items = items
                    ...
                    .map(|ReturningIteratedItem { used_ty, name }| {
                        ...
                        let used_ty_entity_tokens = used_ty.entity_tokens();
                        quote! {
                            ::ogx::utils::sql_entity_graph::OgExternReturnEntityIteratedItem {
                                ty: #used_ty_entity_tokens,
                    ...
                    .collect::<Vec<_>>();
                quote! {
                    ::ogx::utils::sql_entity_graph::OgExternReturnEntity::Iterated {
                        tys: vec![
                            #(#quoted_items),*
                        ],
                        optional: #optional,
            ...
            //     ::ogx::utils::sql_entity_graph::OgExternReturnEntity::Trigger
            // },
        };
