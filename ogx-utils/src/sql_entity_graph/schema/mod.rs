...
`#[og_schema]` related macro expansion for Rust to SQL translation
...
/// A parsed `#[og_schema] mod example {}` item.
///
/// It should be used with [`syn::parse::Parse`] functions.
///
/// Using [`quote::ToTokens`] will output the declaration for a `ogx::datum::sql_entity_graph::InventorySchema`.
///
/// ```rust
/// use syn::{Macro, parse::Parse, parse_quote, parse};
/// use quote::{quote, ToTokens};
/// use ogx_utils::sql_entity_graph::Schema;
///
/// # fn main() -> eyre::Result<()> {
/// let parsed: Schema = parse_quote! {
///     #[og_schema] mod example {}
/// };
...
impl Parse for Schema {
    fn parse(input: ParseStream) -> Result<Self, syn::Error> {
        ...
        crate::ident_is_acceptable_to_opengauss(&module.ident)?;
        Ok(Self { module })
    }
}
...
impl ToTokens for Schema {
    fn to_tokens(&self, tokens: &mut TokenStream2) {
        ...
        let sql_graph_entity_fn_name = syn::Ident::new(
            &format!("__ogx_internals_schema_{}_{}", ident, postfix),
            Span::call_site(),
        );
        updated_content.push(syn::parse_quote! {
                ...
                pub extern "Rust" fn  #sql_graph_entity_fn_name() -> ::ogx::utils::sql_entity_graph::SqlGraphEntity {
                    ...
                    use alloc::vec::Vec;
                    use alloc::vec;
                    let submission = ogx::utils::sql_entity_graph::SchemaEntity {
                            module_path: module_path!(),
                            name: stringify!(#ident),
                            file: file!(),
                            line: line!(),
                        };
                    ::ogx::utils::sql_entity_graph::SqlGraphEntity::Schema(submission)
                }
        });
