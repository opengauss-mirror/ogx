...
use crate::{
    item_pointer_get_both, item_pointer_set_all, pg_sys, FromDatum, IntoDatum, OgMemoryContexts,
};
...
impl IntoDatum for pg_sys::ItemPointerData {
    ...
    fn into_datum(self) -> Option<pg_sys::Datum> {
        let tid = self;
        let tid_ptr =
            OgMemoryContexts::CurrentMemoryContext.palloc_struct::<pg_sys::ItemPointerData>();
        let (blockno, offno) = item_pointer_get_both(tid);
