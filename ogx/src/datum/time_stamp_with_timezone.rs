...
impl TimestampWithTimeZone {
    ...
    #[deprecated(
        since = "0.5.0",
        note = "the repr of ogx::TimestampWithTimeZone is no longer time::OffsetDateTime \
    ...
    pub fn new(time: time::PrimitiveDateTime, at_tz_offset: UtcOffset) -> Self {
        ...
        offset
            .try_into()
            .expect("unable to convert time::PrimitiveDateTime to ogx::TimestampWithTimeZone")
    }
}
