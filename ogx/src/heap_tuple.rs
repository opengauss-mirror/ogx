...
//!
//! [`PgHeapTuple`]s also describe composite types as defined by [`ogx::composite_type!()`][crate::composite_type].
use crate::pg_sys::{Datum, Oid};
use crate::{
    heap_getattr_raw, pg_sys, AllocatedByOpenGauss, AllocatedByRust, FromDatum, IntoDatum, OgBox,
    OgMemoryContexts, PgTupleDesc, TriggerTuple, TryFromDatumError, WhoAllocated,
};
...
pub struct PgHeapTuple<'a, AllocatedBy: WhoAllocated<pg_sys::HeapTupleData>> {
    tuple: OgBox<pg_sys::HeapTupleData, AllocatedBy>,
...
impl<'a> FromDatum for PgHeapTuple<'a, AllocatedByRust> {
    ...
    unsafe fn from_datum_in_memory_context(
        mut memory_context: OgMemoryContexts,
        composite: Datum,
        is_null: bool,
        _oid: pg_sys::Oid,
    ) -> Option<Self>
...
impl<'a> PgHeapTuple<'a, AllocatedByOpenGauss> {
    ...
    pub unsafe fn from_heap_tuple(tupdesc: PgTupleDesc<'a>, heap_tuple: pg_sys::HeapTuple) -> Self {
        Self { tuple: OgBox::from_pg(heap_tuple), tupdesc }
    }
    ...
    ) -> Option<PgHeapTuple<'a, AllocatedByOpenGauss>> {
        let tupdesc =
    ...
    pub fn into_owned(self) -> PgHeapTuple<'a, AllocatedByRust> {
        ...
        PgHeapTuple {
            tuple: unsafe { OgBox::<pg_sys::HeapTupleData, AllocatedByRust>::from_rust(copy) },
    ...
    */
    pub fn new_composite_type(
        ...
        unsafe {
            ...
            Ok(PgHeapTuple {
                tuple: OgBox::<pg_sys::HeapTupleData, AllocatedByRust>::from_rust(heap_tuple),
                tupdesc: tuple_desc,
            })
        }
    }
    ...
    pub fn from_datums<I: IntoIterator<Item = Option<pg_sys::Datum>>>(
        ...
        unsafe {
            ...
            Ok(Self {
                tuple: OgBox::<pg_sys::HeapTupleData, AllocatedByRust>::from_rust(formed_tuple),
                tupdesc,
            })
        }
    }
    ...
    pub unsafe fn from_composite_datum(composite: pg_sys::Datum) -> Self {
        ...
        let mut data = OgBox::<pg_sys::HeapTupleData>::alloc0();
    ...
    pub fn set_by_index<T: IntoDatum>(
        ...
        unsafe {
            ...
            let new_tuple = OgBox::<pg_sys::HeapTupleData, AllocatedByRust>::from_rust(
...
To PostgreSQL, these types are a [`ogx::pg_sys::HeapTuple`][crate::pg_sys::HeapTuple], which is a
pointer to a [`ogx::pg_sys::HeapTupleData`][crate::pg_sys::HeapTupleData]. `ogx` provides more idiomatic
wrapping of this type with [`ogx::heap_tuple::PgHeapTuple`][crate::heap_tuple::PgHeapTuple].

This `composite_type!()` macro expands into a [`ogx::heap_tuple::PgHeapTuple`][crate::heap_tuple::PgHeapTuple].

```rust
assert_eq!(
    core::any::TypeId::of::<ogx::composite_type!("Dog")>(),
    core::any::TypeId::of::<ogx::heap_tuple::PgHeapTuple<'static, ::ogx::AllocatedByRust>>(),
);
assert_eq!(
    core::any::TypeId::of::<ogx::composite_type!('static, "Dog")>(),
    core::any::TypeId::of::<ogx::heap_tuple::PgHeapTuple<'static, ::ogx::AllocatedByRust>>(),
);
const DOG_COMPOSITE_TYPE_IDENT: &str = "Dog";
assert_eq!(
    core::any::TypeId::of::<ogx::composite_type!('static, DOG_COMPOSITE_TYPE_IDENT)>(),
    core::any::TypeId::of::<ogx::heap_tuple::PgHeapTuple<'static, ::ogx::AllocatedByRust>>(),
);
```
...
Used inside of a [`#[og_extern]`][crate::og_extern] definition, this macro alters the generated SQL to use the given
composite type name.

Meaning that this function:

```rust,no_run
use ogx::{prelude::*, AllocatedByRust};
...
CREATE FUNCTION "scritch"(
        "maybe_dog" Dog /* core::option::Option<ogx::heap_tuple::PgHeapTuple<ogx::ogbox::AllocatedByRust>> */
) RETURNS Dog /* core::option::Option<ogx::heap_tuple::PgHeapTuple<ogx::ogbox::AllocatedByRust>> */
LANGUAGE c /* Rust */
...
fn this_dog_name_or_your_favorite_dog_name(
    dog: ogx::default!(ogx::composite_type!("Dog"), "ROW('Nami', 0)::Dog"),
) -> &str {
    // Gets resolved to:
...
Composite types are very **runtime failure** heavy, as opposed to using PostgreSQL types `ogx` has
a builtin compatable type for, or a [`#[derive(ogx::OgType)`][crate::OgType] type. Those options
...
It's possible to create composite types of a given identifier with [`ogx::heap_tuple::PgHeapTuple::new_composite_type`][crate::heap_tuple::PgHeapTuple::new_composite_type].

 */
#[macro_export]
macro_rules! composite_type {
    ($lt:lifetime, $composite_type:expr) => {
        ::ogx::heap_tuple::PgHeapTuple<$lt, ::ogx::AllocatedByRust>
    };
    ($composite_type:expr) => {
        ::ogx::heap_tuple::PgHeapTuple<'static, ::ogx::AllocatedByRust>
    };
}

unsafe impl SqlTranslatable for crate::heap_tuple::PgHeapTuple<'static, AllocatedByOpenGauss> {
